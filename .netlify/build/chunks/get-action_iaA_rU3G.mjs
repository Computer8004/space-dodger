import { A as AstroError, c as ActionNotFoundError } from './astro/server_MEB9lWux.mjs';
...
async function getAction(path) {
  ...
  let { server: actionLookup } = await import('./_astro_internal-actions_kIElSFI_.mjs');
